...
export const UI: Record<Locale, Strings> = {
  en: {
    ...
    copied: "Copied",
    logTags: { chain: "chain", counter: "counter", follow: "follow-up", miss: "missed", brk: "Break!", kill: "defeated", crit: "crit!", refresh: "dances again", engage: "Engage!", disengage: "engage ended", warp: "warped", guard: "Chain Guard" },
  ...
  ko: {
    ...
    copyRecord: "기보 복사",
    copied: "복사됨",
    logTags: { chain: "체인", counter: "반격", follow: "추격", miss: "빗나감", brk: "브레이크!", kill: "격파", crit: "필살!", refresh: "재행동", engage: "인게이지!", disengage: "인게이지 종료", warp: "워프", guard: "체인가드" },
    chapterSelect: "챕터 선택",
    comingSoon: "준비 중",
