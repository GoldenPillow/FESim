...
export const FIDELITY: readonly FidelityEntry[] = [
  ...
  },
  {
    ...
    label: { en: "Skill activation filters (Stand/Action/Timing)", ko: "스킬 발동 필터(Stand/Action/Timing) 준수" },
    status: "anchored",
  ...
  },
  {
    ...
    label: { en: "Battle-local granted skills (Cycle 0)", ko: "전투 로컬 부여(Cycle 0 — 신속 사슬)" },
    status: "implemented",
    evidence:
  ...
  {
    id: "skills.give-sids",
    label: { en: "Granted skills persisting after battle (GiveSids)", ko: "전투 후 영속 부여(GiveSids — Cycle != 0)" },
    status: "deferred",
    evidence:
  ...
  },
  {
    ...
    label: { en: "Per-order damage multipliers in AI target scoring", ko: "AI 표적 평가의 오더별 배율 반영" },
    status: "anchored",
    evidence:
