...
- **타일 셀렉터 = 좌표 라벨**: `i.tile[title^="C5 "]` — 타일 title이 `C5 지형명`(체스식, A1 = 좌하단).
...
뤼에르 D4 · 반드레 C4 · 클란 C3 · 프랑 C5(체술+ライブ) · 적 G4/I3 · 루미엘(우군) K4.
손상 만들기 = 반드레로 G4 공격(반격 9 피해) → 프랑 C5 선택 → F4(전진한 반드레) 호버 = 힐 예보.
